...
class Pentagon implements Runnable {
...
class Hexagon implements Runnable {
...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        Thread bob_1 = new Thread(new Triangle());
        Thread bob_2 = new Thread(new Rectangle());
        Thread bob_3 = new Thread(new Pentagon());
        Thread bob_4 = new Thread(new Hexagon());
        bob_1.start();
        bob_2.start();
        bob_3.start();
        bob_4.start();
...
//        setposition_bob( bob1,bob2,bob3,bob4);
    }
